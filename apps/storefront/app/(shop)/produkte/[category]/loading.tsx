  ...
  return (
    <main className="min-h-screen bg-[#f5f5f7]">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-4 h-4 w-40 animate-pulse rounded bg-[#e5e7eb]" />
        <div className="mb-2 h-8 w-56 animate-pulse rounded-lg bg-[#e5e7eb]" />
        <div className="mb-8 h-4 w-80 animate-pulse rounded bg-[#e5e7eb]" />
